...
{
    public sealed class ObjectReleasedCondition : IInteractionCondition
    {
        ...
        public ObjectReleasedCondition(IEventBus eventBus, string targetObjectId)
        {
        ...
        {
            return _eventBus.On("ObjectReleased")
