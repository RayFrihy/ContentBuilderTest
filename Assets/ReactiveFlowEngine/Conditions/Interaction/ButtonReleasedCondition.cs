...
{
    public sealed class ButtonReleasedCondition : IInteractionCondition
    {
        ...
        public ButtonReleasedCondition(IEventBus eventBus, string buttonId)
        {
        ...
        {
            return _eventBus.On("ButtonReleased")
