...
{
    public sealed class ObjectTouchedCondition : IInteractionCondition
    {
        ...
        public ObjectTouchedCondition(IEventBus eventBus, string targetObjectId)
        {
        ...
        {
            return _eventBus.On("ObjectTouched")
