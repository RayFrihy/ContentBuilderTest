...
{
    public sealed class ObjectSelectedCondition : IInteractionCondition
    {
        ...
        public ObjectSelectedCondition(IEventBus eventBus, string targetObjectId)
        {
        ...
        {
            return _eventBus.On("ObjectSelected")
