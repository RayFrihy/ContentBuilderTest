...
{
    public sealed class ObjectUsedCondition : IInteractionCondition
    {
        ...
        public ObjectUsedCondition(IEventBus eventBus, string targetObjectId)
        {
        ...
        {
            return _eventBus.On("ObjectUsed")
