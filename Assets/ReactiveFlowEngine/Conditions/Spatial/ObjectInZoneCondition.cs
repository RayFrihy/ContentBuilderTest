...
{
    public sealed class ObjectInZoneCondition : ISpatialCondition
    {
        ...
        public ObjectInZoneCondition(ISceneObjectResolver resolver, string targetObjectId, string zoneObjectId)
        {
