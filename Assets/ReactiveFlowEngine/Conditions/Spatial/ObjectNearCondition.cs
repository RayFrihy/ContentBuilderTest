...
{
    public sealed class ObjectNearCondition : ISpatialCondition
    {
        ...
        public ObjectNearCondition(ISceneObjectResolver resolver, string targetObjectId, string referenceObjectId, float threshold)
        {
